...
class __Mustache_89f3c887d87df4c75cd069cd8db7b7f6 extends Mustache_Template
{
...
';
            $buffer .= $indent . '            <a href="#" id="user-menu-toggle" data-bs-toggle="dropdown" aria-label="';
            $value = $context->find('str');
            $buffer .= $this->section4e1672c73dd70427ed6b223d1fa8d13b($context, $indent, $value);
            $buffer .= '"
';
            $buffer .= $indent . '               aria-haspopup="true" aria-controls="user-action-menu" class="dropdown-toggle">';
            $value = $this->resolveValue($context->findDot('output.theme_lambda2_get_user_fullname'), $context);
