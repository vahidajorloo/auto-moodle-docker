...
class __Mustache_d90c1462914686d47ef161d9759424fa extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div class="course-meta d-none">
';
        $buffer .= $indent . '        <span id="meta-coursename">';
        $value = $this->resolveValue($context->findDot('output.lambda2_get_course_fullname'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '</span>
';
        $buffer .= $indent . '        <span id="meta-coursecategory">';
        $value = $this->resolveValue($context->findDot('output.lambda2_get_course_category'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '</span>
';
        $buffer .= $indent . '        <span id="meta-courseimage">';
        $value = $this->resolveValue($context->findDot('output.theme_lambda2_get_courseimage'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '</span>
';
        $buffer .= $indent . '    </div>
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <div id="lambda-page-header">
';
        $buffer .= $indent . '        ';
        $value = $this->resolveValue($context->findDot('output.lambda2_course_header'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '    </div>
