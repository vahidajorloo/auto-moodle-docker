...
class __Mustache_d9daf78a8a4b5ff742ec0e8fe23212d6 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div id="page-content-footer">
';
        $buffer .= $indent . '    <div id="page-content" class="row">
';
        $buffer .= $indent . '        <div id="region-main-box" class="col-xs-12 col-12">
';
        $value = $context->find('secondarymoremenu');
        $buffer .= $this->sectionAea1dcf61908ed65a5686fd3ba3c1ef9($context, $indent, $value);
        $value = $context->find('hasregionmainsettingsmenu');
        $buffer .= $this->sectionC90acabadcc8c996437ac93a6cb6d2cd($context, $indent, $value);
...
';
        ...
        $buffer .= $this->section32fd2b7bb3d421367fb1618a7c163855($context, $indent, $value);
        $buffer .= $indent . '                    ';
...
';
    ...
    private function sectionC90acabadcc8c996437ac93a6cb6d2cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section32fd2b7bb3d421367fb1618a7c163855(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
