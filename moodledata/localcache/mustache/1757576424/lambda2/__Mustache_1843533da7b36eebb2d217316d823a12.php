...
class __Mustache_1843533da7b36eebb2d217316d823a12 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section226b6ca35200e364ca3731ed14371bf9($context, $indent, $value);
            $value = $context->find('haschildren');
            if (empty($value)) {
...
';
    ...
    private function section226b6ca35200e364ca3731ed14371bf9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
