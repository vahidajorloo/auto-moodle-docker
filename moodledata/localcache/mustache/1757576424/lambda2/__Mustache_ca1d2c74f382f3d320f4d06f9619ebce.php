...
class __Mustache_ca1d2c74f382f3d320f4d06f9619ebce extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    ';
        $value = $this->resolveValue($context->findDot('output.theme_lambda2_dashboard_info_stats'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '                    ';
...
';
        ...
        $buffer .= $this->sectionDc29ca0d917fbf5ef1ed6e767de848c3($context, $indent, $value);
...
';
    ...
    private function sectionDc29ca0d917fbf5ef1ed6e767de848c3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'const headerElement = document.querySelector("#page-header .d-flex.align-items-center > .mb-3.mt-3");
';
                $buffer .= $indent . 'if (headerElement && headerElement.textContent.length > 2) {
';
                $buffer .= $indent . '    var greeting = headerElement.textContent.trim();
';
                $buffer .= $indent . '    greeting = greeting.slice(0, -2);
';
                $buffer .= $indent . '    headerElement.textContent = greeting;
';
                $buffer .= $indent . '    headerElement.classList.add("visible");
';
                $buffer .= $indent . '}
';
