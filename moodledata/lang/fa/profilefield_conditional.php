...
/**
 * Strings for component 'profilefield_conditional', language 'fa', version '5.0'.
 *
...
$string['notice'] = 'اگر بیش از یک فیلد شرطی دارید، لطفا دقت مضاعفی بفرمایید تا شرایط تعیین‌شده برای این فیلدها با یکدیگر تداخل نداشته باشد. لطفا بررسی کنید تا حالتی پیش نیاید که یک فیلد درآنِ‌واحد هم مخفی و هم اجباری باشد.';
